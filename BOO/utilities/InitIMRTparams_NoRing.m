function [StructureInfo, params] = InitIMRTparams_NoRing(M, dose_data,masks,pdose)
    ...
    for kk = 1:numBeam
        ...
        % convert range [-180, 180] to [0, 360]
        if VarianIECgantry < 0
            VarianIECgantry = VarianIECgantry + 360;
        end
        if VarianIECcouch < 0
            VarianIECcouch = VarianIECcouch + 360;
        end
